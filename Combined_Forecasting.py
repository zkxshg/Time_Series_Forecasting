// Combined TS forecasting model by 1) Auto-ARIMA 2) SES 3) ETS 4) Prophet
// Determine combined weight by test set error
...
def prophet(data, Pre_day):
    ...
    fig1.show()
    print("===============區間=========================")
    savedata = forecast[['ds', 'yhat', 'yhat_lower', 'yhat_upper']]
    m.plot(forecast)
    savedata.to_csv('prein.csv')
    print("===============區間=========================")
